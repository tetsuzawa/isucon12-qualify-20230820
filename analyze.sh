...
ALPM="/api/organizer/player/[a-z0-9-A-Z]+/disqualified,/api/organizer/competition/[a-z0-9-A-Z]+/finish,/api/organizer/competition/[a-z0-9-A-Z]+/score,/api/player/player/[a-z0-9-A-Z]+,/api/player/competition/[a-z0-9-A-Z]+/ranking"
